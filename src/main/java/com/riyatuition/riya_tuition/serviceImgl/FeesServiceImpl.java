...
public class FeesServiceImpl implements FeesService {
    ...
    public FeesModel createFees(FeesModel model) {
        ...
        ClassFeesEntity classFee = classFeesRepo.findByStandard_Id(student.getStandard().getId())
    ...
    private FeesModel mapToModel(FeesEntity entity) {
        ...
        String standardName = (student != null && student.getStandard() != null) ? student.getStandard().getName()
                : "N/A";
